-- Chốn Học Tập: diễn đàn V17.
-- Video/âm thanh không giới hạn thời lượng nên không bắt buộc duration_seconds.
-- Giữ nguyên tổng media 50 MB và video tối đa 720p.
...
comment on function public.validate_forum_media_limits() is
  'Không giới hạn thời lượng video/âm thanh; duration có thể null; tổng media 50 MB; video tối đa 720p.';
